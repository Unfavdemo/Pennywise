      ...
      <main className="flex-1 px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-gray-900 mb-4">Features That Make a Difference</h1>
          ...
          <section className="mb-16">
            <h2 className="text-center text-gray-900 mb-8">Core Features</h2>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white border border-gray-200 rounded-xl p-6 hover:border-emerald-500 hover:shadow-lg transition-all">
                <div className="w-12 h-12 bg-emerald-100 rounded-lg flex items-center justify-center mb-4">
                  <Clock className="w-6 h-6 text-emerald-600" />
                </div>
                <h3 className="text-gray-900 mb-2">Quick Transaction Entry</h3>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 hover:border-blue-500 hover:shadow-lg transition-all">
                <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-4">
                  <PieChart className="w-6 h-6 text-blue-600" />
                </div>
                <h3 className="text-gray-900 mb-2">Smart Categories</h3>
                <p className="text-gray-600 text-sm mb-4">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 hover:border-purple-500 hover:shadow-lg transition-all">
                <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center mb-4">
                  <Target className="w-6 h-6 text-purple-600" />
                </div>
                <h3 className="text-gray-900 mb-2">Savings Goals</h3>
                <p className="text-gray-600 text-sm mb-4">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 hover:border-amber-500 hover:shadow-lg transition-all">
                <div className="w-12 h-12 bg-amber-100 rounded-lg flex items-center justify-center mb-4">
                  <TrendingUp className="w-6 h-6 text-amber-600" />
                </div>
                <h3 className="text-gray-900 mb-2">Visual Insights</h3>
                <p className="text-gray-600 text-sm mb-4">
          ...
          <section className="mb-16">
            <h2 className="text-center text-gray-900 mb-8">Why Choose Pennywise?</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-gray-900 mb-3">Built for Students</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-gray-900 mb-3">Simple & Approachable</h3>
                <p className="text-gray-600">
          ...
          <section className="mb-16">
            <div className="bg-gray-50 rounded-2xl p-8 md:p-12">
              <h2 className="text-gray-900 mb-6 text-center">How AI Solves Real Problems</h2>
                ...
                <div>
                  <div className="bg-white rounded-xl p-6 border border-gray-200 mb-4">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-gray-900 mb-1">Problem: Manual categorization is tedious</h4>
                        <p className="text-gray-600 text-sm">Students abandon budgeting because sorting every transaction takes too long</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-emerald-50 rounded-xl p-6 border border-emerald-200">
                    <div className="flex items-start gap-4">
                      <div className="text-2xl">✅</div>
                      <div>
                        <h4 className="text-emerald-700 mb-1">AI Solution: Auto-categorization</h4>
                        <p className="text-gray-700 text-sm">AI reads "Starbucks coffee" and instantly suggests "Food & Dining" - you just confirm or adjust</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <div className="bg-white rounded-xl p-6 border border-gray-200 mb-4">
                    <div className="flex items-start gap-4">
                      <div className="text-2xl">🤷</div>
                      <div>
                        <h4 className="text-gray-900 mb-1">Problem: No idea what's "normal" spending</h4>
                        <p className="text-gray-600 text-sm">Students don't know if spending $200 on food is reasonable or excessive</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-emerald-50 rounded-xl p-6 border border-emerald-200">
                    <div className="flex items-start gap-4">
                      <div className="text-2xl">✅</div>
                      <div>
                        <h4 className="text-emerald-700 mb-1">AI Solution: Personalized insights</h4>
                        <p className="text-gray-700 text-sm">AI compares to your history: "Food spending up 30% this month" with context and suggestions</p>
                      </div>
                    </div>
                  </div>
                </div>
