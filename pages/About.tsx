    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-gray-900 mb-4">Understanding the Problem</h1>
          ...
          <section className="mb-12">
            <div className="bg-emerald-50 border-l-4 border-emerald-500 p-6 rounded-r-lg mb-6">
              <h2 className="text-gray-900 mb-4">The Student Financial Challenge</h2>
          ...
          <section className="mb-12">
            <h2 className="text-gray-900 mb-6">How This Shows Up in Real Life</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white border border-gray-200 p-6 rounded-xl">
                <AlertCircle className="w-8 h-8 text-orange-500 mb-4" />
                <h3 className="text-gray-900 mb-3">The Mystery of Disappearing Money</h3>
              ...
              <div className="bg-white border border-gray-200 p-6 rounded-xl">
                ...
                <h3 className="text-gray-900 mb-3">Inability to Save for Goals</h3>
                <p className="text-gray-600">
              ...
              <div className="bg-white border border-gray-200 p-6 rounded-xl">
                ...
                <h3 className="text-gray-900 mb-3">End-of-Month Panic</h3>
                <p className="text-gray-600">
              ...
              <div className="bg-white border border-gray-200 p-6 rounded-xl">
                ...
                <h3 className="text-gray-900 mb-3">Lack of Financial Literacy</h3>
                <p className="text-gray-600">
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-xl border border-blue-200">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-gray-900 mb-3">A Realistic Student Scenario</h3>
          ...
          {/* Why It's Difficult */}
          <section className="mb-12">
            <h2 className="text-gray-900 mb-6">Why Solving This Is Challenging</h2>
            <div className="space-y-4">
              <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                <h3 className="text-gray-900 mb-2">Limited Financial Education</h3>
                <p className="text-gray-600">Most schools don't teach personal finance, leaving students to figure it out on their own through trial and error.</p>
              </div>
              
              <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                <h3 className="text-gray-900 mb-2">Variable Income Sources</h3>
                <p className="text-gray-600">Unlike salaried adults, students have irregular income from multiple sources - part-time work, family support, financial aid - making budgeting complex.</p>
              </div>
              
              <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                <h3 className="text-gray-900 mb-2">Habit-Building Difficulty</h3>
                <p className="text-gray-600">Creating a consistent habit of tracking expenses requires discipline and motivation, especially when students are already overwhelmed with coursework.</p>
              </div>
              
              <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                <h3 className="text-gray-900 mb-2">Time Constraints</h3>
                <p className="text-gray-600">Students are busy with classes, homework, jobs, and social life. Complex budgeting systems get abandoned because they take too much time.</p>
              </div>
              
              <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                <h3 className="text-gray-900 mb-2">Existing Tools Are Too Complex</h3>
                <p className="text-gray-600">Traditional finance apps are designed for adults with mortgages, investments, and retirement planning - overwhelming and irrelevant for students.</p>
              </div>
            </div>
          </section>
          ...
          {/* Consequences */}
          <section className="mb-12">
            <h2 className="text-gray-900 mb-6">What Happens If We Don't Solve This</h2>
          ...
          {/* Existing Solutions */}
          <section className="mb-12">
            <h2 className="text-gray-900 mb-6">Current Solutions & Their Limitations</h2>
            <div className="bg-white border-2 border-gray-200 rounded-xl overflow-hidden">
              <div className="bg-gray-100 p-6 border-b border-gray-200">
                <h3 className="text-gray-900">Example: Mint (by Intuit)</h3>
                <p className="text-gray-600 mt-2">A popular personal finance app used by millions</p>
              </div>
              
              <div className="grid md:grid-cols-2 divide-x divide-gray-200">
                <div className="p-6">
                  <h4 className="text-emerald-600 mb-4">What Worked ✓</h4>
                ...
                <div className="p-6 bg-gray-50">
                  <h4 className="text-red-600 mb-4">What Didn't Work ✗</h4>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start gap-2">
                      <span className="text-red-500 mt-1">✗</span>
